...
<main>
    <div class="container">
        <div class="main-content border border-sage rounded-lg p-8">
            <h1 class="text-xl font-semibold capitalize">Update Product</h1>
            <?php include 'views/includes/flasher.php' ?>
            <form action="<?= route('products.update?product_id=' . $product['data']['product_id']); ?>" method="post" enctype="multipart/form-data" class="mt-4">
                <div class="grid grid-cols-2 gap-5 mb-4">
                    ...
                    <div class="w-full flex flex-col items-start relative group/input">
                        ...
                        <input type="text" class="w-full text-sm border rounded-lg border-sage px-4 py-3 outline-none focus-within:border" name="product[title]" id="title" value="<?= $_SESSION['form_alert']['data']['title'] ?? $_SESSION['flash']['data']['title'] ?? $product['data']['title'] ?? ''; ?>">
                    ...
                    <div class="w-full flex flex-col items-start relative group/input">
                        ...
                        <input type="text" class="w-full text-sm border rounded-lg border-sage px-4 py-3 outline-none" name="product[price]" id="price" value="<?= $_SESSION['form_alert']['data']['price'] ?? $_SESSION['flash']['data']['price'] ?? $product['data']['price'] ?? ''; ?>">
                        <div class="w-full min-h-7">
                    ...
                    <div class="w-full flex flex-col items-start relative group/input">
                        ...
                        <input type="text" class="w-full text-sm border rounded-lg border-sage px-4 py-3 outline-none" name="product[stock]" id="stock" value="<?= $_SESSION['form_alert']['data']['stock'] ?? $_SESSION['flash']['data']['stock'] ?? $product['data']['stock'] ?? ''; ?>">
                        <div class="w-full min-h-7">
                ...
                <div class="w-full flex flex-col items-start relative group/input">
                    ...
                    <input type="text" class="w-full text-sm border rounded-lg border-sage px-4 py-3 outline-none" name="product[description]" id="description" maxlength="100" value="<?= $_SESSION['form_alert']['data']['description'] ?? $_SESSION['flash']['data']['description'] ?? $product['data']['description'] ?? ''; ?>">
                    <div class="w-full min-h-7">
