...
<main>
    <div class="container">
        <div class="main-content border border-sage rounded-lg p-8">
            <h1 class="text-xl font-semibold capitalize">Update User</h1>
            <?php include 'views/includes/flasher.php' ?>
            <form action="<?= route('users.update?user_id=' . $user['data']['user_id']); ?>" method="post" enctype="multipart/form-data" class="mt-4">
                <div class="w-full flex flex-col items-start relative group/input">
                    ...
                    <input type="text" class="w-full text-sm border rounded-lg border-sage px-4 py-3 outline-none focus-within:border" name="auth[name]" id="name" value="<?= $_SESSION['form_alert']['data']['name'] ?? $_SESSION['flash']['data']['name'] ?? $user['data']['name'] ?? ''; ?>">
                ...
                <div class="grid grid-cols-2 gap-5">
                    <div class="w-full flex flex-col items-start relative group/input">
                        ...
                        <input type="email" class="w-full text-sm border rounded-lg border-sage px-4 py-3 outline-none focus-within:border" name="auth[email]" id="email" value="<?= $_SESSION['form_alert']['data']['email'] ?? $_SESSION['flash']['data']['email'] ?? $user['data']['email'] ?? ''; ?>">
                        <div class="w-full min-h-8">
                    ...
                    <div class="w-full flex flex-col items-start relative group/input">
                        ...
                        <select name="auth[role]" id="role" class="w-full text-sm border rounded-lg border-sage px-4 py-3 outline-none focus-within:border">
                            <?php foreach ($roles['data'] as $role) : ?>
                                <option value="<?= $role['role_id'] ?>" <?= ($role['role_id'] == $user['data']['role_id']) ? 'selected="selected"' : '' ?>>
                                    <?= $role['title']; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="grid grid-cols-2 gap-5">
                    <div class="w-full flex flex-col items-start relative group/input">
                        ...
                        <input type="password" class="w-full text-sm border rounded-lg border-sage px-4 py-3 outline-none focus-within:border" name="auth[password]" id="password" value="<?= $_SESSION['form_alert']['data']['password'] ?? $_SESSION['flash']['data']['password'] ?? $user['data']['password'] ?? ''; ?>">
                    ...
                    <div class="w-full flex flex-col items-start relative group/input">
                        ...
                        <input type="password" class="w-full text-sm border rounded-lg border-sage px-4 py-3 outline-none focus-within:border" name="auth[confirm_password]" id="confirm_password" value="<?= $user['data']['password'] ?? ''; ?>">
                        <?php if (!isset($_SESSION['form_alert']['error']['not_match_password'])) : ?>
                            <div class="w-full min-h-8">
                ...
                <div class="w-full flex flex-col items-start relative group/input">
                    ...
                    <input type="text" class="w-full text-sm border rounded-lg border-sage px-4 py-3 outline-none" name="auth[address]" id="address" maxlength="100" value="<?= $_SESSION['form_alert']['data']['address'] ?? $_SESSION['flash']['data']['address'] ?? $user['data']['address'] ?? ''; ?>">
                    <div class="w-full min-h-8">
                ...
                <div class="grid grid-cols-2 gap-5 mb-4">
                    <div class="w-full flex flex-col items-start relative group/input">
                        ...
                        <input type="text" class="w-full text-sm border rounded-lg border-sage px-4 py-3 outline-none focus-within:border" name="auth[postal_code]" id="postal_code" value="<?= $_SESSION['form_alert']['data']['postal_code'] ?? $_SESSION['flash']['data']['postal_code'] ?? $user['data']['postal_code'] ?? ''; ?>">
                        <div class="w-full min-h-8">
                    ...
                    <div class="w-full flex flex-col items-start relative group/input">
                        ...
                        <input type="text" class="w-full text-sm border rounded-lg border-sage px-4 py-3 outline-none focus-within:border" name="auth[phone_number]" id="phone_number" value="<?= $_SESSION['form_alert']['data']['phone_number'] ?? $_SESSION['flash']['data']['phone_number'] ?? $user['data']['phone_number'] ?? ''; ?>">
                        <div class="w-full min-h-8">
